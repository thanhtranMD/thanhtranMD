...
{
    /*
     Example provided from: https://docs.microsoft.com/en-us/dotnet/standard/parallel-programming/walkthrough-using-dataflow-in-a-windows-forms-application
     */
    public partial class CompositeImageForm : Form
    {
       ...
       for (int j = 0; j < largest.Height; j++)
        ...
        private void tsbChooseFld_Click(object sender, EventArgs e)
        {
